    ...
    <div class="wrapper" style="min-height: 223.667px;">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "aduanPenangananSelesaiKortek.php?pagination=true&keyword=$keyword";
          ...
          $reload = "aduanPenangananSelesaiKortek.php?pagination=true";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="aduanPenangananSelesaiKortek.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Refresh" href="aduanPenangananSelesaiKortek.php"><i class="fas fa-sync"></i> Refresh</a>
                      <?php
                        }
                        ?>
                    </div>
