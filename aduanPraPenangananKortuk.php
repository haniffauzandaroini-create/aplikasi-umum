    ...
    <div class="wrapper" style="min-height: 223.667px;">
      ...
      <div class="content-wrapper">
        ...
        <?php include 'pagination.php';
          ...
          $reload = "aduanPraPenangananKortuk.php?pagination=true&keyword=$keyword";
          ...
          $reload = "aduanPraPenangananKortuk.php?pagination=true";
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm mb-2">
                <form method="post" action="aduanPraPenangananKortuk.php">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      ...
                      <?php
                        if($_REQUEST['keyword']<>""){
                        ?>
                      <a class="btn btn-sm btn-warning" title="Refresh" href="aduanPraPenangananKortuk.php"><i class="fas fa-sync"></i> Refresh</a>
                      <?php
                        }
                        ?>
                    </div>
