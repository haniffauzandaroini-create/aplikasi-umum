            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-8">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="rekapGudang.php">Persediaan Barang</a></li>
                  <li class="breadcrumb-item"><a href="aitemKeluarPertahun.php?page=<?php echo $page;?>">Pengeluaran</a></li>
            ...
            <div class="row">
              <section class="col-lg-6 col-md-6 col-sm-12 connectedSortable">
                <?php include 'pagination1.php';
                  $reload1 = "aitemKeluarPerBulan.php?tahun=$tahun&page=$page&pagination=true";
                      ...
                      <table class="table table-hover m-0 table-sm custom">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="pr-1"><a class="btn btn-info btn-xs btn-block" href="aitemKeluarPerTgl.php?tahun=<?php echo $tahun;?>&bulan=<?php echo $data['bulan'];?>&page=<?php echo $page;?>&page1=<?php echo $page1;?>" title="Lihat Detail"><i class="fas fa-angle-double-right"></i> Lihat Detail</a></td>
                          </tr>
                          <?php
                            $i1++; 
                            $count1++;
